...
//		ReminderLog.e("demo", "onTextChanged start:"+start+" count:"+count+" before:"+before);
		editStart = start;
		editCount = count;
	}
...
//		ReminderLog.e("demo", "beforeTextChanged start:"+start+" count:"+count+" after:"+after);
	}
...
//		ReminderLog.e("demo", "content:"+content);
